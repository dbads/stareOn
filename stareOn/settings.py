...
WSGI_APPLICATION = 'stareOn.wsgi.application'
...
STATIC_ROOT = PROJECT_DIR.child('stareOn','static_root')
...
MEDIA_URL = '/media/'
MEDIA_ROOT = PROJECT_DIR.child('stareOn','media_root')
